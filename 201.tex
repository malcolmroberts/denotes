...
$$
\begin{tabular}{ l |  l }
  $\displaystyle  f(t)$ & $\displaystyle \Laplace(f) = F(s)$  \\
  \hline
  \hline
  $\displaystyle f'(t)$ 
  & $\displaystyle sF(s) -f(0)$\\ \hline
  $\displaystyle f''(t)$ 
  & $\displaystyle s^2F(s) -sf(0) - f'(0)$\\ \hline
  $\displaystyle f^{(n)}(t)$ 
  & $\displaystyle s^nF(s) -s^{n-1}f(0)-\dots - f^{(n-1)}(0)$\\ \hline
  ...
  $\displaystyle e^{\a t}f(t) $ 
  & $\displaystyle F(s-\a) $ \\ \hline
  ...
  \multirow{2}{*}{$\displaystyle u_c(t)$}
  & \multirow{2}{*}{$\displaystyle \frac{e^{-cs}}{s}$} \\ \\ \hline
  $\displaystyle u_c(t)f(t-c)$ 
  & $\displaystyle e^{-cs}F(s)$ \\ \hline
  $\displaystyle \delta(t)$ 
  & $\displaystyle 1$ \\ \hline
