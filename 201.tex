...
FIXME: add formula for periodic oscilator with general source term.
...
\be
y = cu_c(t) + \frac{c}{2} t^2.
\ee
FIXME: add $\Laplace{}\(f(t-c)(u_c(t)\)=e^{-cs}F(s)$ to the tables.
}
...
% Actually, I'm not so sure that Gibbs is a good problem.
\end{enumerate}
...
% FIXME: do we need this section?
%\subsection{Table of Identities}
%\begin{align}\nonumber
%& 
%& 
%\\\nonumber
