...
\usepackage[paperwidth=9cm, paperheight=12cm, hmargin={0.17in, 0.17in}, vmargin={0.50in, 0.17in}]{geometry}
}{}
...
\begin{definition}\emph{Regular singular points.}
  ...
  \eqref{singode} if the two limits $\lim_{t\rightarrow 0} t p(t)
...
\begin{dmath}
%FIXME: boxed breaks line-wrapping
%  \boxed{
    u(x,t)=\frac{2}{\pi}
